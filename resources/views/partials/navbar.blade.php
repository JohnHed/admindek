<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            <a href="{{route('home')}}">
                <img src="{{asset('img/logo.png')}}" alt="Theme-Logo" height="60" />
            </a>
            ...
            <ul class="nav-left">
                ...
                <li>
                    <a href="#!"
                        ...
                        class="waves-effect waves-light" data-cf-modified-217e103332d64f28bbeeb749-="">
                ...
                <li class="header-notification">
                    <div class="dropdown-primary dropdown">
                        ...
                        <ul class="show-notification notification-view dropdown-menu notification-header-menu"
                            ...
                            <li>
                                <div class="media">
                                    <img class="img-radius" src="{{asset('img/default.gif')}}"
            ...
            <div class="media chat-messages">
                <a class="media-left photo-table" href="#!">
                    <img class="media-object img-radius img-radius m-t-5"
                        src="{{asset('img/default.gif')}}" alt="Generic placeholder image">
                </a>
